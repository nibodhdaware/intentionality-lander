    ...
    <div className="min-h-screen bg-[#0f1a2a] text-slate-200 selection:bg-sky-500/30">
      ...
      <main className="pt-32 pb-20 container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {platforms.map((platform, i) => (
            ...
            >
              <Card className={`h-full bg-white/[0.02] border-white/10 ${platform.available ? 'hover:border-sky-500/30' : 'opacity-70'} transition-all group overflow-hidden relative shadow-2xl`}>
                <CardContent className="p-8">
                  ...
                  <h2 className="text-2xl font-bold text-white mb-3 tracking-tight">{platform.name}</h2>
                  ...
                  {platform.available ? (
                    ...
                    <Button disabled className="w-full bg-white/5 text-slate-500 border border-white/5 font-bold h-12 rounded-xl cursor-not-allowed">
                      {platform.buttonText}
                    </Button>
                  )}
                </CardContent>
        ...
        <section className="mt-24 max-w-4xl mx-auto bg-sky-500/5 border border-sky-500/20 rounded-[2.5rem] p-8 md:p-12 text-center shadow-2xl">
           ...
           <div className="flex flex-wrap justify-center gap-4">
             <Button variant="outline" className="border-white/10 hover:bg-white/5 rounded-full px-8">View Guide</Button>
             <Button asChild variant="outline" className="border-white/10 hover:bg-white/5 rounded-full px-8">
      ...
      <footer className="py-12 border-t border-white/5">
        <div className="container mx-auto px-6 text-center">
           <p className="text-slate-600 text-xs tracking-widest uppercase">© 2026 Intentionality • Built with intention</p>
        </div>
      </footer>
    </div>
  );
