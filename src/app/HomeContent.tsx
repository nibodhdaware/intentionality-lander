...
export default function HomeContent() {
  ...
  const trackInstallClick = (placement: string) => {
    posthog.capture("install_click", { placement, source: "home" });
  };
  ...
  return (
    <div className="min-h-screen bg-[#0f1a2a] text-slate-200 selection:bg-sky-500/30">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-20 pb-24 md:pt-28 md:pb-32 lg:min-h-[980px]">
        <motion.div className="container relative mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="max-w-3xl text-left lg:max-w-[40%] xl:max-w-[38%]"
          >
            {/* Icon and Logo */}
            <motion.div
              ref={heroIconRef}
            ...
            >
              <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-[1.25rem] border border-white/10 bg-[#16253b] shadow-2xl shadow-sky-500/20 transition-transform duration-500 hover:scale-105 md:h-20 md:w-20">
                <Image src="/iconog.png" alt="Intentionality Icon" width={80} height={80} priority />
              </div>
              <div className="flex flex-col gap-2">
                <span className="text-2xl font-black tracking-tighter text-white md:text-3xl">Intentionality</span>
                <div className="h-1 w-10 bg-gradient-to-r from-sky-500 to-indigo-500 rounded-full" />
              </div>
            </motion.div>

            <Badge variant="outline" className="mb-6 border-sky-500/30 text-sky-400 bg-sky-500/5 px-3 py-1 text-xs md:text-sm">
              Available for Chrome, Android & Firefox
            </Badge>
            ...
            <p className="max-w-2xl text-base md:text-lg text-slate-400 mb-8 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 flex-wrap">
                {(platform === 'chrome' || platform === 'other') && (
                  <Button asChild size="lg" className="h-14 px-8 bg-sky-500 hover:bg-sky-600 text-white rounded-full text-lg font-semibold shadow-lg shadow-sky-500/20 group">
                    <a href="https://chromewebstore.google.com/detail/intentionality/bgmlmjomgakcgkgngpeimmkofpicpbfn" onClick={() => trackInstallClick("hero-primary")}>
                ...
                {platform === 'firefox' && (
                  <Button asChild size="lg" className="h-14 px-8 bg-orange-500 hover:bg-orange-600 text-white rounded-full text-lg font-semibold shadow-lg shadow-orange-500/20 group">
                    <a href="https://addons.mozilla.org/en-GB/firefox/addon/intentionality/" target="_blank" rel="noopener noreferrer" onClick={() => trackInstallClick("hero-firefox")}>
          ...
          <motion.div
            ...
            className="relative mt-16 pb-12 lg:absolute lg:right-0 lg:top-10 lg:mt-0 lg:w-[54%] lg:max-w-4xl xl:w-[50%]"
          >
            <div className="relative w-full ml-auto rounded-2xl overflow-hidden border border-white/10 shadow-2xl shadow-sky-500/10">
              <Image
                src="/intentionality-desktop-screenshot.png"
                alt="Intentionality Chrome extension desktop screenshot"
                width={1576}
                height={998}
            ...
            <div className="absolute -bottom-6 -left-4 w-[26%] max-w-[200px] rounded-[1.5rem] overflow-hidden border border-white/20 shadow-2xl shadow-orange-500/20">
              <Image
                src="/intentionality-mobile-screenshot.jpg"
                alt="Intentionality mobile intention check screenshot"
                width={768}
                height={1664}
                className="w-full h-auto"
              />
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div className="space-y-6">
                    ...
                    <Button asChild className="bg-sky-500 hover:bg-sky-600 text-white font-bold h-12 px-8 rounded-xl shadow-lg shadow-sky-500/20">
                      <a href="https://chromewebstore.google.com/detail/intentionality/bgmlmjomgakcgkgngpeimmkofpicpbfn" target="_blank" rel="noopener noreferrer" onClick={() => trackInstallClick("platform-tabs")}>
                        Get the extension
                      </a>
                    </Button>
                  </div>
              ...
              <TabsContent value="firefox" className="mt-0">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div className="space-y-6">
                    ...
                    <Button asChild className="bg-orange-500 hover:bg-orange-600 text-white font-bold h-12 px-8 rounded-xl transition-all">
                      <a href="https://addons.mozilla.org/en-GB/firefox/addon/intentionality/" target="_blank" rel="noopener noreferrer" onClick={() => trackInstallClick("platform-tabs-firefox")}>
                        Add to Firefox
                      </a>
                    </Button>
                  </div>
      ...
      <section id="pricing" className="py-24">
        <div className="container mx-auto px-6">
          <div className="mx-auto max-w-5xl rounded-[2.25rem] border border-white/10 bg-white/[0.03] p-8 md:p-12">
            <div className="mb-10 text-center">
              <Badge variant="outline" className="mb-4 border-sky-500/30 bg-sky-500/5 px-4 py-1 text-sky-400">
                Premium
              </Badge>
              <h2 className="text-3xl font-bold text-white md:text-4xl">
                Unlock advanced Intentionality features
              </h2>
              <p className="mx-auto mt-4 max-w-2xl text-slate-400">
                Core blocking and intervention stays free. Premium is a one-time $9 unlock for
                the dumbness graph, per-site custom prompts, and deeper configuration controls.
              </p>
            </div>
            <PremiumCheckout />
          </div>
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            ...
            <AccordionItem value="item-5" className="border border-white/10 rounded-xl px-6 bg-white/5 data-[state=open]:border-sky-500/30 transition-colors">
              ...
              <AccordionContent className="text-slate-300 text-base leading-relaxed pb-6">
                The core features of Intentionality are free to use. Premium is now available on this website for advanced features like the dumbness graph, custom prompt configuration, and deeper controls. The essential blocking and prompting experience remains accessible for free.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="mt-12 text-center">
            <div className="flex flex-wrap justify-center gap-6 text-sm font-medium">
              <Link href="/guides/intentional-internet-usage-tips" className="text-slate-400 hover:text-white transition-colors">
                View all guides and resources
              </Link>
              <Link href="/compare" className="text-slate-400 hover:text-white transition-colors">
                Compare Intentionality
              </Link>
              <Link href="/alternatives" className="text-slate-400 hover:text-white transition-colors">
                Alternatives
              </Link>
              <Link href="/for" className="text-slate-400 hover:text-white transition-colors">
                Use Cases by Persona
              </Link>
              <Link href="/chrome-extension-to-stop-distractions" className="text-slate-400 hover:text-white transition-colors">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Button asChild size="lg" className="h-14 px-10 bg-sky-500 hover:bg-sky-600 text-white rounded-full text-lg font-bold shadow-xl shadow-sky-500/20 group/btn transition-all active:scale-95">
                  <a href="https://chromewebstore.google.com/detail/intentionality/bgmlmjomgakcgkgngpeimmkofpicpbfn" onClick={() => trackInstallClick("final-cta")}>
                    <Chrome className="mr-2 h-5 w-5" />
                    Install on Chrome
                  </a>
                </Button>
