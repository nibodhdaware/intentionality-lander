...
export const metadata: Metadata = {
    ...
    title: {
        default:
            "Intentionality | Stop Mindless Scrolling & Reclaim Your Focus",
        template: "%s | Intentionality",
    },
    description:
        "Take control of your browsing habits. Pause before you scroll. Add Intentionality for mindful, distraction-free browsing.",
    other: {
        "ai-content": "https://intentionality.app/llms.txt",
    },
    icons: {
        icon: [{ url: "/iconog.png", type: "image/png" }],
        shortcut: "/iconog.png",
        apple: "/iconog.png",
    },
    openGraph: {
        ...
        description:
            "Take control of your browsing habits. Pause before you scroll.",
