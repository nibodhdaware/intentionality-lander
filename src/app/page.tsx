        ...
        <motion.div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 flex-wrap">
              ...
              <Button disabled variant="outline" size="lg" className="h-14 px-8 border-white/10 bg-white/5 text-slate-500 rounded-full text-lg font-semibold cursor-not-allowed">
                <svg className="mr-2 h-5 w-5 opacity-50" viewBox="0 0 256 150" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                  <defs>
                    <mask id="android-mask-hero-fixed">
               ...
               <TabsContent value="mobile" className="mt-0">
                 <div className="grid md:grid-cols-2 gap-12 items-center">
                   <div className="space-y-6">
                     ...
                     <Button disabled className="bg-white/5 text-slate-500 border border-white/5 font-bold h-12 px-8 rounded-xl cursor-not-allowed">
